  ...
  function printReceiptThermal(order){
      ...
      <head>
        ...
        <style>
          * { margin: 0; padding: 0; box-sizing: border-box; }
          ...
          .order-grid { display: grid; grid-template-columns: 1fr; gap: 4px; font-size: 12px; }
          .order-cell { display:flex; flex-direction:column; padding: 3px 0; border-bottom: 1px dotted #d1d5db; }
          .order-cell .label { font-weight:700; color:#111827; font-size:11px; letter-spacing: 0.04em; }
          .order-cell .value { text-align:left; padding-left: 6px; font-weight:600; color:#374151; }

          /* Section 2: Items table */
          .items-table { margin-top:8px; }
          .section-title { font-weight: 800; font-size: 13px; margin-bottom: 4px; text-transform: uppercase; }
    ...
    billHTML += `
        ...
        <div class="billing-summary">
          ...
          <div style="border-top: 1px solid #000; margin: 4px 0 2px 0;"></div>
